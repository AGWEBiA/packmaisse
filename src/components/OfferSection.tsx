        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 items-start">
          <ScrollReveal direction="left">
            <div className="space-y-3 sm:space-y-4">
              {items.map((item, i) => (
                <div key={i} className="glass-card rounded-lg sm:rounded-xl p-3.5 sm:p-4 flex items-start gap-3 sm:gap-4 card-hover">
                  <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-accent/10 flex items-center justify-center shrink-0 mt-0.5">
          ...
          <ScrollReveal direction="right">
            <div className="rounded-2xl sm:rounded-3xl bg-gradient-to-br from-primary via-primary to-accent p-1 shadow-2xl shadow-primary/20 glow-primary">
              <div className="rounded-[calc(1rem-4px)] sm:rounded-[calc(1.5rem-4px)] bg-gradient-to-br from-primary to-accent p-6 sm:p-8 lg:p-10 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-primary-foreground/60 line-through text-xl sm:text-2xl font-[Poppins] font-bold mb-4 sm:mb-6">R$ 1.988</p>
                  <p className="text-primary-foreground/70 text-xs sm:text-sm mb-2">Mas hoje, você tem acesso por apenas:</p>
                  <p className="text-primary-foreground text-5xl sm:text-6xl font-[Poppins] font-extrabold mb-1 tracking-tight">R$ 297</p>
                  <p className="text-primary-foreground/60 text-xs sm:text-sm mb-8 sm:mb-10">ou 12x de R$ 29,70</p>
                  <Button
                    size="lg"
                    onClick={scroll}
                    className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 w-full py-6 sm:py-7 text-sm sm:text-base font-bold shadow-xl rounded-xl"
                  >
                    Quero Acelerar Meu Escritório Agora!
                  </Button>
                  <div className="flex items-center justify-center gap-2 mt-4 sm:mt-5">
                    <Shield className="text-primary-foreground/60" size={12} />
